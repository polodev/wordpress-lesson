...
module.exports = [{"uri":"https://polodev.github.io/wordpress-lesson/posts/wordpress-class-one/","title":"Wordpress Class One","tags":["wordpress","Basic"],"content":" Discussed subject  Frontend Backend programming language How to installed wordpress  Rule and regulation  make a excel file for daily 4 hours time keeping. Column will be following\n Name (first row) SI (starting from 4th row, first column) title description start time (video) end time (video) spend time resource link post done (yes/no; whether I have posted on 2 facebook post in wordpress learning bangladesh page or not) comment (Yes/No)  Whenever practicing wordpress write mamurjor shibu dev polo start time in skype group. At ending write mamurjor shibu deb polo end time. At start and at end make screenshot and upload in skype group.\n A single session will be not less than 30 minutes\n  WordPress basic topic listed on fb group  WordPress - Home WordPress - Overview WordPress - Installation WordPress - Dashboard WordPress Settings WordPress - General Setting WordPress - Writing Setting WordPress - Reading Setting WordPress - Discussion Setting WordPress - Media Setting WordPress - Permalink Setting WordPress - Plugin Setting WordPress Categories WordPress - Add Category WordPress - Edit Category WordPress - Delete Category WordPress - Arrange Categories WordPress Posts WordPress - Add Posts WordPress - Edit Posts WordPress - Delete Posts WordPress - Preview Posts WordPress - Publish Posts WordPress Media WordPress - Media Library WordPress - Add Media WordPress - Insert Media WordPress - Edit Media WordPress Pages WordPress - Add Pages WordPress - Publish Pages WordPress - Edit Pages WordPress - Delete Pages WordPress Tags WordPress - Add Tags WordPress - Edit Tags WordPress - Delete Tags WordPress Links WordPress - Add Links WordPress - Edit Links WordPress - Delete Links WordPress Comments WordPress - Add Comments WordPress - Edit Comments WordPress - Moderate Comments WordPress Plugins WordPress - View Plugins WordPress - Install Plugins WordPress - Customize Plugins WordPress Users WordPress - User Roles WordPress - Add Users WordPress - User Photo WordPress - Edit Users WordPress - Delete Users WordPress - Personal Profile WordPress Appearance WordPress - Theme Management WordPress - Customize Theme WordPress - Widget Management WordPress - Background WordPress Advanced WordPress - Host Transfer WordPress - Version Update WordPress - Spam Protection WordPress - Reset Password WordPress Useful Resources WordPress - Questions and Answers WordPress - Quick Guide WordPress - Useful Resources WordPress - Discussion  "}]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DateApp__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Search__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__SingleSearchResult__ = __webpack_require__(33);
...
if (search_result) {
  Object(__WEBPACK_IMPORTED_MODULE_1_react_dom__["render"])(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__SingleSearchResult__["a" /* default */], null), search_result);
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dates_index__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_fuzzy_search__ = __webpack_require__(31);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ba__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bn__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ia__ = __webpack_require__(30);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__docs_index_json__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lunr__ = __webpack_require__(7);
...
var Search = function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      ...
      var after_domain = document.body.dataset.after_domain;
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        'form',
        { method: 'get', action: '/' + after_domain + '/search' },
...
var Search = function (_React$Component) {
  ...
  function Search(prop) {
    ...
    _this._getTitleByUri = _this._getTitleByUri.bind(_this);
    _this._getQueryVariable = _this._getQueryVariable.bind(_this);
    return _this;
  }
  // _changeQueryAndFilter (e) {
  //   let query = e.target.value
  ...
  _createClass(Search, [{
    ...
    value: function componentDidMount() {
      ...
      this.setState({ lunrIndex: lunrIndex }, function () {
        _this2._search();
      });
    }
  }, {
    ...
    key: '_getQueryVariable',
    value: function _getQueryVariable(variable) {
    ...
    value: function render() {
      ...
      return search_results.length ? __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        'div',
        null,
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
          'h2',
          ...
          search_results.map(function (result, index) {
            return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
              ...
              __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                'a',
                { href: result.ref },
                _this3._getTitleByUri(result.ref)
              )
            );
          })
        )
